        ...
        <div style={{ padding: "40px", maxWidth: "900px", margin: "0 auto", lineHeight: "1.6", color: "#ffffffff", fontFamily: "Arial, sans-serif" }}>
            <h1 style={{ fontSize: "2.5rem", marginBottom: "20px" }}>About This Project</h1>
                ...
                <p>
                    ...
                    If you would like to learn more about this project, see it in action, or discuss my approach and experience, please feel free to <strong><Link to="/Footer" style={{ textDecoration: "none", color: "#007bff" }}>contact me</Link></strong></p>
        </div>
    );
}
