    ...
    >
      ...
      ></path>
        ...
        <input
          ...
          style={{ padding: "10px", width: "300px", marginRight: "10px",marginBottom:"40px" }}
        />
        ...
        <button type="submit" style={{ padding: "20px" ,color:"white",backgroundColor:"red",fontSize:"20px",height:"20px",display:"flex",alignItems:"center"}}>Search</button>
      </form>
